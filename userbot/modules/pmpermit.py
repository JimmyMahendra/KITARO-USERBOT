...
CUSTOM_TEXT = str(
    PMPERMIT_TEXT) if PMPERMIT_TEXT else f"__Halo kawan, saya bot yang menjaga room chat KITARO-USERBOT {owner} di mohon jangan melakukan spam , kalau anda melakukan itu OTOMATIS saya akan memblockir anda!__ \n"
DEF_UNAPPROVED_MSG = (
    "╔═════════════════════════╗\n"
    ...
    "╔═════════════════════╗\n"
    f"➠ 𝗢𝘄𝗻𝗲𝗿 : {owner} \n"
    f"➠ 𝗣𝗲𝘀𝗮𝗻 𝗢𝘁𝗼𝗺𝗮𝘁𝗶𝘀 𝗯𝘆 𝙺ιтαяσ-υѕєявσ𝚃\n"
    "╚═════════════════════╝")
# =================================================================
...
@jim_cmd(pattern="(set|get|reset) pm_msg(?: |$)(\\w*)")
