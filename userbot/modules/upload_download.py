...
from userbot.utils import progress, humanbytes, edit_or_reply, edit_delete, jim_cmd


@jim_cmd(pattern="download(?: |$)(.*)")
...
@jim_cmd(pattern="uploadas(stream|vn|all) (.*)")
