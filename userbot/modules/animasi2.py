...
@jim_cmd(pattern=r"^\.(yes|no|maybe|decide)$")
...
@jim_cmd(pattern=r"^\.fp$")
async def facepalm(e):
    await e.edit("🤦‍♂")


@jim_cmd(pattern=r"^\.cry$")
async def cry(e):
    await e.edit(choice(CRI))


@jim_cmd(pattern=r"^\.insult$")
async def insult(e):
    await e.edit(choice(INSULT_STRINGS))


@jim_cmd(pattern=r"^\.cp(?: |$)(.*)")
...
@jim_cmd(pattern=r"^\.hello$")
async def hoi(hello):
    await hello.edit(choice(HELLOSTR))


@jim_cmd(pattern=r"^\.owo(?: |$)(.*)")
async def focos(owo):
...
@jim_cmd(pattern=r"^\.react$")
async def react_meme(react):
    await react.edit(choice(FACEREACTS))


@jim_cmd(pattern=r"^\.shg$")
async def shrugger(shg):
    await shg.edit(choice(SHGS))


@jim_cmd(pattern=r"^\.chase$")
async def police(chase):
    await chase.edit(choice(CHASE_STR))


@jim_cmd(pattern=r"^\.run$")
async def runner_lol(run):
    await run.edit(choice(RUNS_STR))


@jim_cmd(pattern=r"^\.metoo$")
...
@jim_cmd(pattern=r"^\.10iq$")
async def iqless(e):
    await e.edit("♿")


@jim_cmd(pattern=r"^\.fuck$")
async def iqbot(e):
    await e.edit("🖕🖕🖕🖕🖕🖕🖕🖕\n🖕🖕🖕🖕🖕🖕🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕🖕🖕🖕🖕\n🖕🖕🖕🖕🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕")


@jim_cmd(pattern=r"^\.bye$")
async def iqboot(e):
    await e.edit("Kek thx bye")


@jim_cmd(pattern=r"^\.moon$")
...
@jim_cmd(pattern=r"^\.taco$")
async def taco(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(r"{\__/}" "\n(●_●)" "\n( >🌮 Want a taco?")


@jim_cmd(pattern=r"^\.paw$")
async def paw(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`(=ↀωↀ=)")


@jim_cmd(pattern=r"^\.tf$")
async def tf(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("(̿▀̿ ̿Ĺ̯̿̿▀̿ ̿)̄  ")


@jim_cmd(pattern=r"^\.gey$")
async def gey(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "`\n┈┈┈╭━━━━━╮┈┈┈┈┈\n┈┈┈┃┊┊┊┊┊┃┈┈┈┈┈`"
...
@jim_cmd(pattern=r"^\.(?:penis|dick)\s?(.)?")
