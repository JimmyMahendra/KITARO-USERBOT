...
from userbot.utils import edit_delete, jim_cmd, reply_id
...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}button test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/ChannelKitaro:same> [Support]<buttonurl:https://t.me/rumahkitaro3>`\
    "
    }
)
