...
from userbot.utils import edit_or_reply, edit_delete, jim_cmd
...
REPOLINK = str(
    UPSTREAM_REPO_URL) if UPSTREAM_REPO_URL else "https://github.com/Kitaroo/JM-Userbot"
# ============================================
...
async def killdabot(event):
    ...
    await edit_or_reply(event, "`Mematikan JM-Userbot....`")
...
async def killdabot(event):
    await edit_or_reply(event, "`Restarting JM-Userbot...`")
...
@jim_cmd(pattern="readme$")
async def reedme(e):
    await edit_or_reply(e,
                        "Here's Something for You to Read :\n"
                        "\n[☣️ JM-Userbot Repo](https://github.com/Kitaroo/JM-Userbot/blob/JM-Userbot/README.md)"
                        "\n[Setup Guide - Basic](https://telegra.ph/How-to-host-a-Telegram-Userbot-11-02)"
                        "\n[Special - Note](https://telegra.ph/Special-Note-11-02)")


@jim_cmd(pattern="repeat (.*)")
...
CMD_HELP.update({
    ...
    \n↳ : `{cmd}sleep`\
    \n  •  **Function : Biarkan JM-Userbot tidur selama beberapa detik.",
    "shutdown": f"𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}shutdown`\
    \n↳ : Mematikan bot",
    "repo": f"𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}repo`\
    \n↳ : Menampilan link Repository JM-Userbot.",
    "string": f"𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}string`\
    \n↳: Menampilkan link String JM-Userbot",
